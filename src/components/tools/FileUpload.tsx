    ...
    <div
      className={cn(
        ...
        dragActive
          ...
          : "border-white/40 dark:border-zinc-700 bg-white/10 dark:bg-zinc-900/10 hover:border-white/60 dark:hover:border-zinc-600 hover:bg-white/20 dark:hover:bg-zinc-800/20",
