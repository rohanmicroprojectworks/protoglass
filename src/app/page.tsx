            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 px-4">
                {availableTools.map((tool, index) => (
                  ...
                  >
                    <div className={cn(tool.themeColor, "p-6 rounded-3xl shadow-xl dark:shadow-2xl dark:shadow-current/20 group-hover:rotate-6 group-hover:scale-110 transition-all duration-500")}>
